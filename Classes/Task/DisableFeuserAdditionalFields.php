 ...
 *
 */
class DisableFeuserAdditionalFields implements AdditionalFieldProviderInterface
{
    /**
     * Field Name.
     *
    ...
    protected $fieldNames = array(
        'time' => 'disablefeuser_timeOfInactivityToDisable',
        'email' =>'disablefeuser_email',
    );

    protected $languageFile = 'LLL:EXT:disable_feuser/Resources/Private/Language/locallang.xlf:';
    ...
    {
        if (!$task instanceof DisableFeuserTask) {
            throw new \InvalidArgumentException('Expected a task of type SourceLounge\\DisableFeuser\\Task\\DisableFeuserTask, but got ' . get_class($task), 1295012802);
        }
